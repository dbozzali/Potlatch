...
public class OAuth2SecurityConfiguration {
	...
	protected static class ResourceServer extends ResourceServerConfigurerAdapter {
		...
		// all of the paths in the gift service.
		@Override
	...
	protected static class OAuth2Config extends AuthorizationServerConfigurerAdapter {
		...
		public OAuth2Config() throws Exception {
			...
			UserDetailsService svc = new InMemoryUserDetailsManager(
				Arrays.asList(UserSecurity.create("admin", "adminpass", "ADMIN", "USER"),
							  UserSecurity.create("readonlyuser", "readonlyuserpass", "USER"),
							  UserSecurity.create("alice", "alicepass", "USER"),
							  UserSecurity.create("bob", "bobpass", "USER"),
							  UserSecurity.create("carol", "carolpass", "USER")));
